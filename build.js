        ...
        function openCalculator() {
          const calculatorHTML = 
            '<div style="text-align: center; padding: 10px;">' +
              ...
              '<div style="display: grid; grid-template-columns: repeat(4, 1fr); grid-template-rows: repeat(5, 1fr); gap: 2px;">' +
                ...
                '<button onclick="calcEquals()" style="grid-row: span 2;">=</button>' +
